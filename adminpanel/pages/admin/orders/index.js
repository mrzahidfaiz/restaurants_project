          ...
          <tr className="hover:bg-gray-50">
            ...
            <td className="px-6 py-4">
              ...
              <select
                  id="category"
                  name="category"
                  className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-500 focus:border-primary-500 block w-40 p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
                >
                  <option value="">Select category</option>
                  <option value="TV">Pending</option>
                  <option value="PC">Delivered</option>
                </select>
              </div>
            </td>
            <td className="px-6 py-4">
