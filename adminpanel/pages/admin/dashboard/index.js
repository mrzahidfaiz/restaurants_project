...
import { getAllProducts } from '@/pages/api/internalApi';
      ...
      <div className="mt-4 w-full grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-4 mb-4">
          <div className="bg-white shadow rounded-lg p-4 sm:p-6 xl:p-8 ">
            <div className="flex items-center">
              ...
              <div className="ml-5 w-0 flex items-center justify-end flex-1 text-blue-600 text-2xl font-bold">
               {products.length}
              </div>
            </div>
          </div>
          <div className="bg-white shadow rounded-lg p-4 sm:p-6 xl:p-8 ">
            <div className="flex items-center">
              ...
              <div className="ml-5 w-0 flex items-center justify-end flex-1 text-gray-800 text-2xl font-bold">
                32
              </div>
            </div>
          </div>
